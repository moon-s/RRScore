...
# Inputs: /mnt/f/14_restless/MR_ready/ldclump_dhs_sceqtl_onek1k/Finngen_R12_G6_RLS_in_DHS.filtered_to_exposures.tsv.gz; /mnt/f/14_restless/MR_ready/ldclump_dhs_sceqtl_onek1k; MR_parallel_run_summary.tsv
# Input schema: Schema: not fully inferable from script; known columns should be verified against upstream data dictionaries or script-level read statements.
# Outputs: /mnt/f/14_restless/results_mr/results_mr_dhs_sceqtl_RLS; MR_parallel_run_summary.tsv
# Output schema: Schema: not fully inferable from script; preserve existing output filenames and columns.
# How to run: from this script directory, run `Rscript 1_2_run_MR_3methods_sceqtl_rls.r` unless a project-specific driver script documents otherwise.
...
outcome_path <- "/mnt/f/14_restless/MR_ready/ldclump_dhs_sceqtl_onek1k/Finngen_R12_G6_RLS_in_DHS.filtered_to_exposures.tsv.gz"

expo_root <- "/mnt/f/14_restless/MR_ready/ldclump_dhs_sceqtl_onek1k"

out_root  <- "/mnt/f/14_restless/results_mr/results_mr_dhs_sceqtl_RLS"
...
exposures <- c( 'B_int', 'B_mem', 'CD4_ET', 'CD4_NC', 'CD4_SOX4', 'CD8_ET', 'CD8_NC', 'CD8_S100B', 'DC', 'Mono_C', 'Mono_NonC', 'NK', 'NK_rest', 'Plasma' )

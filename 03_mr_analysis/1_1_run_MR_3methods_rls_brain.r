...
# Inputs: /mnt/f/14_restless/MR_ready/ldclump_dhs_brain_qtls/Finngen_R12_G6_RLS_in_neural_DHS.filtered_to_exposures.tsv.gz; /mnt/f/14_restless/MR_ready/ldclump_dhs_brain_qtls; MR_parallel_run_summary.tsv
# Input schema: Schema: not fully inferable from script; known columns should be verified against upstream data dictionaries or script-level read statements.
# Outputs: /mnt/f/14_restless/results_mr/results_mr_dhs_brain_RLS; MR_parallel_run_summary.tsv
# Output schema: Schema: not fully inferable from script; preserve existing output filenames and columns.
# How to run: from this script directory, run `Rscript 1_1_run_MR_3methods_rls_brain.r` unless a project-specific driver script documents otherwise.
...
outcome_path <- "/mnt/f/14_restless/MR_ready/ldclump_dhs_brain_qtls/Finngen_R12_G6_RLS_in_neural_DHS.filtered_to_exposures.tsv.gz"


expo_root <- "/mnt/f/14_restless/MR_ready/ldclump_dhs_brain_qtls"

out_root  <- "/mnt/f/14_restless/results_mr/results_mr_dhs_brain_RLS"
...
# Settings
# =========================
thresholds <- c("r2_0.01" )

exposures <- c( "bulk_brain_eqtl_basalganglia",
"bulk_brain_eqtl_cortex",
"bulk_brain_eqtl_spinalcord",
"bulk_brain_eqtl_cerebellum",
"bulk_brain_eqtl_hippocampus",
'bulk_pqtl_brain', 
'sc_eqtl_singlebrain_Ast' ,
'sc_eqtl_singlebrain_End' ,
'sc_eqtl_singlebrain_Ext' ,
'sc_eqtl_singlebrain_IN' ,
'sc_eqtl_singlebrain_MG' ,
'sc_eqtl_singlebrain_OD' ,
 'sc_eqtl_singlebrain_OPC' 
)
